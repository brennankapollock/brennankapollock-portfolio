export const projects = [
  {
    ...
    description:
      "Building a creative studio focused on experimental projects at the intersection of art, technology, and philosophy.",
  ...
  },
  {
    ...
    description:
      "Minimal portfolio inspired by museum design systems, Stedelijk Museum, and brutalist web design principles.",
  ...
  },
  {
    ...
    description:
      "Developer-first blog system with file-tree navigation, inspired by Stripe Dev Blog and technical documentation sites.",
  ...
  },
  {
    ...
    description:
      "Six years translating desperation into legal documentation. Helping asylum seekers navigate immigration systems.",
    imageUrl: "/placeholder-work-1.jpg",
    year: "2018-2024",
  ...
  },
  {
    ...
    description:
      "Organizing and participating in intentional communities focused on mutual aid, shared resources, and collective liberation.",
    imageUrl: "/placeholder-work-2.jpg",
    year: "2020-2023",
  ...
  },
  {
    ...
    description:
      "Essays and reflections on embodied spirituality, philosophy, and the practice of being fully alive.",
    imageUrl: "/placeholder-work-3.jpg",
    year: "2024-present",
    role: "Writer",
