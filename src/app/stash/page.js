...
export default function StashPage() {
  ...
  const [ui, setUi] = useState({ categories: [], types: [], sort: 'newest', q: '' });
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (raw) {
        ...
        setUi({ categories: [], types: [], sort: 'newest', q: '', ...persisted });
      }
    } catch {}
    setInitialized(true);
    ...
    <div className="blog-layout">
      <div className="blog-container">
        ...
        <div className="stash-content">
          <StashToolbar value={ui} onChange={setUi} itemsCount={filteredItems.length} />
